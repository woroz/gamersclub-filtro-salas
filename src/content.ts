...
let paisActual: string | undefined = undefined
filtrarSalas()
...
document.getElementById("bandera-ar")?.addEventListener("click", () => {
  paisActual = "Argentina";
  filtrarSalas(paisActual);
});

document.getElementById("bandera-br")?.addEventListener("click", () => {
  paisActual = "Brasil";
  filtrarSalas(paisActual);
});
